...
INSTALLED_APPS = [
    ...
    'concepts',
    # The cloakroom desk at an event (CONFERENCE-BRIEF.md §3.F). Its own app rather than more of
    # `events` because what it owns is an ANONYMOUS BEARER TOKEN — a coat is never linked to a
