...
translatable model (Discipline/Branch/Topic/Chapter in taxonomy, Exercise/ExerciseSource in exercises,
...
def request_locale(context, default=DEFAULT_FALLBACK_LOCALE):
    ...
    Adding a single English translation row in the admin was enough to surface it: every reader,
