...
**Browser: `frontend/e2e/venues.mjs`** — 31 checks against the real servers:
...
keeps working. Screenshots land in `e2e/screens/venues-*.png`; `venues-killed.png` is the one worth
