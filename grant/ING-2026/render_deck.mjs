// Renders every page of EdMat-ING-2026.drawio through draw.io itself (the drawio-lasso web build
...
const drawio = process.argv[2] || path.join(here, 'EdMat-ING-2026.drawio');
const outDir = process.argv[3] || path.join(here, 'slides');
const pdfPath = process.argv[4] || path.join(here, 'EdMat-ING-2026.pdf');
