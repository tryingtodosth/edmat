# EdMat.net — zgłoszenie do Programu Grantowego ING „W rytmie pokoleń” (9. edycja, Liga Seed)

Tekst wszystkich slajdów wyeksportowany z `EdMat-ING-2026.drawio`, a po nim odpowiedzi z formularza. Wygenerowane przez `deck_to_md.py`.
